# EllipticZero Documentation Index

Start here if you need to understand the project quickly.
...
- [Sample Report Shapes](../examples/SAMPLE_OUTPUTS.md)
- [Golden Synthetic Cases](../examples/golden_cases/README.md)
- [Golden Cases Runbook](../examples/golden_cases/RUNBOOK.md)
- [Golden Expected Report Shapes](../examples/golden_cases/EXPECTED_REPORT_SHAPES.md)
...
- [License Transition Notes](../LICENSE_TRANSITION.md)

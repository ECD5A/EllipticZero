...
| `full-local-lab` | широкая локальная среда для ECC, symbolic checks, smart-contract review, replay и bundles | Python 3.11+, `.[lab]` extras | SageMath, Slither, Foundry, Echidna, API-ключ провайдера | `.\scripts\setup_local_lab.ps1` |

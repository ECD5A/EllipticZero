...
Проект сейчас идёт по source-available release track под `FSL-1.1-ALv2`.
...
- Итоговый CLI-отчёт теперь показывает готовую команду для оценки сохранённого
  запуска, если для него был создан пакет воспроизводимости.
- Сохранённые запуски теперь можно экспортировать в SARIF 2.1.0 для CI и
  GitHub Code Scanning.
- SARIF-результаты теперь содержат стабильные partial fingerprints, теги и
  уровень серьёзности EllipticZero для более аккуратного CI-триажа.
...
- Сводки сохранённых запусков теперь включают блок `review_status` с глубиной

...
from app.compute.runners import EchidnaRunner
...
class EchidnaAuditTool(BaseTool):
    """Run a bounded local Echidna property/assertion pass on Solidity source."""

    name = "echidna_audit_tool"
    category = "smart_contract_audit"
    description = "Run a bounded local Echidna property or assertion pass on Solidity source."
    version = "0.1.0"
    input_schema_hint = "SmartContractAuditPayload"
    output_schema_hint = "Bounded Echidna property/assertion result"

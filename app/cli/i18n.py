...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "block.contract_casebook_benchmark_support": "CASEBOOK BENCHMARK SUPPORT",
        ...
        "report.contract_casebook_benchmark_support": "Casebook Benchmark Support",
    ...
    "ru": {
        ...
        "block.contract_casebook_benchmark_support": "ПОДДЕРЖКА CASEBOOK BENCHMARK",
        ...
        "report.contract_casebook_benchmark_support": "Поддержка casebook benchmark",
...
TRANSLATIONS["en"]["doctor.detail.export_policy"] = "Bundle export copies only artifact references that resolve inside approved local storage roots."
...
TRANSLATIONS["ru"]["doctor.detail.export_policy"] = "При экспорте пакета копируются только те ссылки на артефакты, которые разрешаются внутри утверждённых локальных каталогов хранения."

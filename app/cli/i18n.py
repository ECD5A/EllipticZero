...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "workflow.entry_mode.value.smart_contract": "Contract code from file, folder, or paste, plus a free-form audit idea.",
        ...
        "report.saved_run_evaluation": "Saved-run Evaluation",
        ...
        "screen.domain.subtitle": "Choose whether this controlled session starts from a smart-contract audit target or ECC research.",
        ...
        "domain.smart_contract.desc": "Local audit for a contract file, folder, or pasted code with scoped review patterns.",
    ...
    "ru": {
        ...
        "workflow.entry_mode.value.smart_contract": "Код контракта из файла, папки или вставки плюс свободная идея аудита.",
        ...
        "report.saved_run_evaluation": "Сводка сохранённого запуска",
...
TRANSLATIONS["ru"].update(
    {
        ...
        "screen.domain.subtitle": "Выберите, запускается ли контролируемая сессия как аудит смарт-контракта или как ECC-исследование.",
        ...
        "domain.smart_contract.desc": "Локальный аудит файла, папки или вставленного кода контракта с понятными шаблонами проверки.",
...
TRANSLATIONS["en"].update(
    {
        "menu.export_review_files.label": "EXPORT REVIEW FILES",
        "menu.export_review_files.desc": "Write report.md and review.sarif into the session bundle.",
        "menu.show_output_paths.label": "SHOW OUTPUT PATHS",
        "menu.show_output_paths.desc": "Show saved session, trace, bundle, and report paths.",
        ...
        "block.contract_source_scope": "CONTRACT SOURCE SCOPE",
        ...
        "label.entry_file": "ENTRY FILE",
        "label.contract_root": "CONTRACT ROOT",
        "label.contract_files": "CONTRACT FILES",
        "label.language": "LANGUAGE",
        "label.markdown_report": "MARKDOWN REPORT",
        "label.sarif_file": "SARIF FILE",
        "label.sarif_results": "SARIF RESULTS",
        "value.pasted_contract": "pasted contract code",
        "value.single_file_or_paste": "single file / pasted code",
        "message.export_unavailable": "Review export is unavailable because this session has no bundle directory.",
        ...
        "screen.contract_source.subtitle": "Choose a local file or folder, or paste contract code. Solidity/Vyper is inferred automatically.",
        ...
        "prompt.contract.file": "contract file, folder, or code (/back, /cancel, /lang) >",
        "prompt.contract.input_hint": "Drop or paste a file/folder path. Press Enter to paste multi-line code.",
...
TRANSLATIONS["ru"].update(
    {
        ...
        "block.contract_source_scope": "ОБЛАСТЬ ПРОВЕРКИ КОНТРАКТА",
        ...
        "label.replay_export": "REPLAY / EXPORT",
        "label.entry_file": "ВХОДНОЙ ФАЙЛ",
        "label.contract_root": "КОРЕНЬ КОНТРАКТОВ",
        "label.contract_files": "ФАЙЛОВ КОНТРАКТОВ",
        "label.language": "ЯЗЫК",
        "label.markdown_report": "MARKDOWN-ОТЧЁТ",
        "label.sarif_file": "SARIF-ФАЙЛ",
        "label.sarif_results": "SARIF-ЗАПИСЕЙ",
        "value.pasted_contract": "вставленный код контракта",
        "value.single_file_or_paste": "один файл / вставленный код",
        "message.export_unavailable": "Выгрузка недоступна: у сессии нет каталога пакета.",
        ...
        "screen.contract_source.subtitle": "Выбери локальный файл или папку либо вставь код контракта. Solidity/Vyper определяется автоматически.",
        ...
        "prompt.contract.file": "файл, папка или код (/back, /cancel, /lang) >",
        "prompt.contract.input_hint": "Перетащи или вставь путь к файлу/папке. Нажми Enter, чтобы вставить многострочный код.",

...
def build_evaluation_summary_payload(
    *,
    ...
    return {
        ...
        "purpose": [
            "Source-available local lab for bounded smart-contract audit and ECC research.",
    ...
    if lang == "ru":
        return "\n".join(
            [
                ...
                "",
                "Назначение:",
                "- Source-available локальная лаборатория для ограниченного аудита смарт-контрактов и ECC-исследований.",

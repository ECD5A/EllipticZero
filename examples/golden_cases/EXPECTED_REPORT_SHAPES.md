...
- normalized findings include severity, confidence, line evidence, fix direction, and recheck path for review signals
...
- execution and upgrade surfaces are framed as scoped review priorities
...
- oracle-related findings preserve freshness, answer-bound, scaling, and round-completeness review context when present
- manual review queue and bounded confidence remain visible
